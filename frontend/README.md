...
**Live:** [gkmehendiart.com](https://gkmehendiart.com)
...
NEXT_PUBLIC_APP_URL=https://gkmehendiart.com
```
...
public/                 # Static assets
  *.webp                # Portfolio images (39), hero backgrounds (5)
...
**Recommended Region:** Mumbai (bom1) for Indian traffic.
